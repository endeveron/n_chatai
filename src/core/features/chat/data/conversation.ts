...
export const ALT_MESSAGES = [
  ...
  "That's a good one, but I'm not sure of the answer just yet.",
  ...
  "That's outside my current knowledge scope.",
...
export const ERROR_MESSAGES = [
  "Oops! Something went wrong on our end. We're on it.",
  'Ugh! Tech fail. Sit tight while we sort it out.',
  "Dang it! Looks like a glitch happened. We're working to fix it.",
  'Womp womp. That didn’t go as planned. Thanks for your patience.',
  "Hold up! Something went sideways. We're looking into it.",
  "Seriously? Tech issues again. We'll get this resolved ASAP.",
  "Plot twist: tech malfunction! We're handling it behind the scenes.",
  'Welp, that was glitchy. No need to do anything—we’re fixing it.',
  'Hmm, not sure what just happened. Our team’s on it.',
  "Oh for goodness’ sake! That’s on us. We're digging into it.",
  'Dangnabbit! Something broke. We’re already investigating.',
  "Ugh, tech troubles. We're already working to resolve it.",
  'Hold on a sec—technical hiccup. We’ll take it from here.',
  'The struggle is real. No need to retry—we’re fixing the issue.',
];
